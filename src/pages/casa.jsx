...
const amenities = [
  { icon: "👨‍👩‍👧‍👦", title: "8 Personas", description: "Ideal para grupos familiares" },
  { icon: "🛏️", title: "3 Dormitorios", description: "Espacios cómodos para descansar" },
  { icon: "🚿", title: "2 Baños", description: "Completos y modernos" },
  { icon: "🛋️", title: "Living/Comedor", description: "Amplio espacio social" },
  { icon: "🍳", title: "Cocina Completa", description: "Totalmente equipada" },
  { icon: "❄️", title: "Aire Acondicionado", description: "Frío/Calor" },
  { icon: "🔥", title: "Calefactor", description: "Calefacción adicional" },
  { icon: "📺", title: "TV", description: "Entretenimiento garantizado" },
  { icon: "📶", title: "Wi-Fi Gratuito", description: "Internet de alta velocidad" }
];

export default function ModernCasa() {
    ...
    <div className="casa-container">
      ...
      <section className="hero-section">
        ...
        <div className="hero-content">
          <div className="hero-badge">Casa</div>
          <h1 className="hero-title">Casa Familiar</h1>
          <h2 className="hero-subtitle">El Hogar Perfecto para Grupos Grandes</h2>
          <p className="hero-description">
            Amplia casa dentro del complejo, diseñada para brindar comodidad y privacidad 
            a grupos familiares. Cuenta con todos los servicios y espacios 
            necesarios para una estadía inolvidable.
          </p>
          ...
          <div className="hero-stats">
            ...
            <div className="stat-item">
              ...
              <span className="stat-label">Dormitorios</span>
            </div>
            <div className="stat-divider" />
            <div className="stat-item">
              <span className="stat-number">2</span>
              <span className="stat-label">Baños</span>
            </div>
            <div className="stat-divider" />
            <div className="stat-item">
      ...
      <section className="gallery-section">
        <div className="section-container">
          <div className="section-header">
            <h2 className="section-title">Galería de la Casa</h2>
            <p className="section-subtitle">Descubre cada espacio de tu próximo hogar temporal</p>
          </div>
      ...
      <section className="amenities-section">
        <div className="section-container">
          <div className="section-header">
            ...
            <p className="section-subtitle">Una casa completamente equipada para tu comodidad</p>
          </div>
      ...
      <section className="cta-section">
        <div className="cta-container">
          <div className="cta-content">
            <h2 className="cta-title">¿Listo para tu Escapada Familiar?</h2>
            <p className="cta-description">
              Reserva nuestra casa y vive una experiencia única con tu familia y amigos en Villa Carlos Paz
            </p>
