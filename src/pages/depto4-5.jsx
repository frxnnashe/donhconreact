...
const images = [
  ...
  },
  {
    ...
    alt: "Área común del complejo"
  }
];

const amenities = [
  { icon: "👪", title: "4-5 Personas", description: "Perfecto para familias medianas" },
  { icon: "🏠", title: "2 Ambientes", description: "Espacios bien distribuidos" },
  { icon: "🍳", title: "Anafe", description: "Cocina funcional" },
  { icon: "🚿", title: "Antebaño y Baño", description: "Instalaciones completas" },
  { icon: "❄️", title: "Aire Acondicionado", description: "Frío/Calor para tu comfort" },
  { icon: "📶", title: "Wi-Fi Gratuito", description: "Internet de alta velocidad" },
  { icon: "🛋️", title: "Ambiente Social", description: "Espacio para compartir" },
  { icon: "🛏️", title: "Dormitorio", description: "Descanso garantizado" },
  { icon: "🌟", title: "Comodidad", description: "Ideal para familias" }
];

export default function ModernDepto() {
    ...
    <div className="depto-container">
      ...
      <section className="hero-section">
        ...
        <div className="hero-content">
          <div className="hero-badge">Departamento</div>
          <h1 className="hero-title">Departamento 2 Ambientes</h1>
          <h2 className="hero-subtitle">Comodidad y Funcionalidad en Armonía</h2>
          <p className="hero-description">
            Unidad moderna perfectamente equipada para familias que buscan comodidad 
            sin renunciar a la funcionalidad. Espacios bien distribuidos con todas 
            las amenidades necesarias para una estadía placentera.
          </p>
      ...
      <section className="gallery-section">
        <div className="section-container">
          <div className="section-header">
            <h2 className="section-title">Galería del Departamento</h2>
            <p className="section-subtitle">Conoce cada detalle de tu próxima estadía</p>
          </div>
      ...
      <section className="amenities-section">
        <div className="section-container">
          <div className="section-header">
            <h2 className="section-title">Comodidades del Departamento</h2>
            <p className="section-subtitle">Todo lo necesario para tu comodidad y bienestar</p>
          </div>
        ...
        <div className="cta-container">
          <div className="cta-content">
            ...
            <p className="cta-description">
              Reserva nuestro departamento 2 ambientes y disfruta de la comodidad que tu familia merece
            </p>
